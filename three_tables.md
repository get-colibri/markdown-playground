...
| HTML Bold     | <b>HTML Bold</b>HTML Bold                           | Uses `<b>` HTML tag           |
| Line Break    | First line<br>Second line                           | Uses `<br>` for line break    |
| Link          | [OpenAI](https://openai.com)                        | Standard Markdown link        |
| Highlight     | <mark>Highlighted</mark>Highlighted                 | HTML `<mark>` element         |
| Small Text    | <small>Secondary note</small>Secondary note         | HTML `<small>` element        |
| Mixed Styling | **Bold** and <i>Italic HTML</i>Italic HTML combined | Markdown + HTML mixed         |
...
# | Mixed Styling  | **Bold** and <i>Italic HTML</i> combined | Markdown + HTML mixed                   |Second Formatted Tables Example
...
| Highlight      | <mark>Highlighted</mark>                 | HTML `<mark>` element                   |
| Small Text     | <small>Secondary note</small>            | HTML `<small>` element                  |
| Mixed Styling  | **Bold** and <i>Italic HTML</i> combined | Markdown + HTML mixed                   || Feature        | Example                                  | Notes                                  |
|----------------|------------------------------------------|------------------------------------------|
| Bold Text      | **Important**                            | Uses `**bold**` syntax                  |
| Italic Text    | *Emphasis*                               | Uses `*italic*` syntax                  |
| Inline Code    | `const value = 42;`                      | Code formatting inside a cell           |
...
| Highlight      | <mark>Highlighted</mark>                 | HTML `<mark>` element                   |
| Small Text     | <small>Secondary note</small>            | HTML `<small>` element                  |
# | Mixed Styling  | **Bold** and <i>Italic HTML</i> combined | Markdown + HTML mixed                   |Firt Formatted Tables Example
